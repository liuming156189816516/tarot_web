! function(n, e) {
	"object" == typeof exports && "object" == typeof module ? module.exports = e() : "function" == typeof define &&
		define.amd ? define([], e) : "object" == typeof exports ? exports.cnchar = e() : n.cnchar = e()
}(this, (function() {
	return function(n) {
		var e = {};
		...
		return r.m = n, r.c = e, r.d = function(n, e, o) {
			r.o(n, e) || Object.defineProperty(n, e, {
				enumerable: !0,
				get: o
			})
		}, r.r = function(n) {
			"undefined" != typeof Symbol && Symbol.toStringTag && Object.defineProperty(n, Symbol
				.toStringTag, {
					value: "Module"
			...
			if (r.r(o), Object.defineProperty(o, "default", {
				...
				for (var t in n) r.d(o, t, function(e) {
					return n[e]
				}.bind(null, t));
			return o
		}, r.n = function(n) {
		...
		var u = function() {
			...
			var o = Array(n),
				t = 0;
			for (e = 0; e < r; e++)
				for (var a = arguments[e], i = 0, u = a.length; i < u; i++, t++) o[t] = a[i];
			return o
		};
		...
		var s = function(n, e, r) {
			if ("object" != typeof n) r(n, e);
			else
				for (var o in n) r(o, n[o])
		};

		function f(n, e) {
			if (void 0 === e && (e = 1), !n || 0 === n.length || 0 === e) return [];
			if (e >= n.length) return c(Object.assign([], n));
			for (var r = [], o = n.length, t = []; t.length < e;) {
				var a = p(0, o - 1);
				t.includes(a) || (t.push(a), r.push(n[a]))
			}
			return r
		}

		function c(n) {
			for (var e, r, o = n.length; o;) r = Math.floor(Math.random() * o--), e = n[o], n[o] =
				n[r], n[r] = e;
			return n
		}
		...
		var h = function(n) {
			var e;
			return 1 === n.length ? !!n.match(/[\u4e00-\u9fa5]/) : (null === (e = n.match(
					/[\u4e00-\u9fa5]/g)) || void 0 === e ? void 0 : e.join("").length) === n
				.length
		};
		var d = function(n, e) {
			return -1 !== n.indexOf(e)
		};
		var g, v = "āáǎàōóǒòēéěèīíǐìūúǔùǖǘǚǜ*ńňǹ",
			y = {
				array: "array",
				low: "low",
				up: "up",
				...
				for (var s = n[l], f = parseInt(s[0]), c = function(n) {
						...
						if (h(e)) {
							...
							if (-1 !== c) {
								...
								if (p.poly) {
									u[n] || (u[n] = []), o(p.res);
									for (var d = s, g = d.match(new RegExp(e, "g")).length, v =
											1; v < g; v++) c = (d = d.substr(c + 2)).indexOf(e),
										o(T(l, d, c, a, i, f).res)
								} else p.isPolyWord && t.spellDefault[e] && (p.res = S(t
									.spellDefault[e], i).spell), u[n] = [p.res], r[n] = ""
							}
						} else "" !== e && (u[n] = ["NOT_CNCHAR", e])
					}, p = 0; p < r.length; p++) c(p);
			w(u, o);
			var g = [];
			for (p = 0; p < r.length; p++) {
				var v = u[p];
				void 0 === v ? g[p] = r[p] : v.length > 1 ? "NOT_CNCHAR" === v[0] ? g[p] = v[1] : g[
						p] = "(" + v.join("|") + ")" : g[p] = v[0], d(o, y.flat) && d(o, y.tone) &&
					(g[p] = P(g[p], !0))
			}
			return d(o, y.array) ? g : g.join("")
		}
		var w = function(n, e) {
			g._.poly && k(n, O), d(e, y.first) && k(n, b), d(e, y.up) ? k(n, j) : d(e, y.low) ||
				k(n, z)
		};

		function k(n, e) {
			n.forEach((function(r, o) {
				"string" != typeof r ? "NOT_CNCHAR" !== r[0] && r.forEach((function(n,
					o) {
					r[o] = e(n)
				})) : n[o] = e(r)
			}))
		...
		function T(n, e, r, o, t, a) {
			...
			return o || t ? (u.isPolyWord && (i -= 5, o && (u.poly = !0)), t && (u.res = _(n, a,
				i)), u) : u
		}
		...
		function q(n, e) {
			var r = e[0].split(""),
				o = [],
				t = e.splice(1);
			for (var a in E("stroke", t), n)
				for (var i = 0; i < r.length; i++) r[i] && -1 !== n[a].indexOf(r[i]) && (r[i] = "",
					o[i] = parseInt(a));
				...
				if (g.check)
					if (A) A = !1;
						...
						for (var o = [], t = e.length - 1; t >= 0; t--) {
							var a = e[t];
							g.type[n][a] || (o.push(a), e.splice(t, 1))
						}
						var i = [],
							u = [],
							l = function(n, r) {
								void 0 === r && (r = i), n instanceof Array ? n.forEach((function(
								n) {
									l(n, r)
								})) : d(e, n) && r.push(n)
							}; - 1 === g.plugins.indexOf("trad") && (d(e, "simple") && i.push(
								"simple"), d(e, "trad") && i.push("trad")), "spell" === n ? d(e,
								"up") && d(e, "low") && i.push("low") : "stroke" === n ? d(e,
								"order") ? (l("array", u), d(e, "letter") ? (l(["detail", "shape",
									"name", "count"
								]), l("letter", u)) : d(e, "detail") ? l(["shape", "name",
								"count"]) : d(e, "shape") ? l(["name", "count"]) : d(e, "name") &&
								l(["count"])) : (l(["detail", "shape", "name", "letter"]), l(
								"count", u)) : "orderToWord" === n ? d(e, "match") ? l([
								"matchorder", "contain", "start"
							]) : d(e, "matchorder") ? l(["contain", "start"]) : d(e, "contain") &&
							l(["start"]) : "strokeToWord" === n || "spellToWord" === n ||
							"idiom" === n && (d(e, "spell") ? l(["stroke", "char"]) : d(e,
								"stroke") ? l(["tone", "char"]) : l(["tone"])), N(o, "无效", n, e), N(
								i, "被忽略", n, e), N(u, "冗余", n, e)
					}
			};
		...
		function N(n, e, r, o) {
			if (n.length > 0) {
				...
				"被忽略" !== e || "stroke" !== r || d(o, "order") ? t += " 可选值：[" + Object.keys(g.type[
					r]) + "]" : t += " 要启用笔顺模式必须使用 order 参数", l(t)
			}
		}
		...
		function P(n, e) {
			...
			if (!e) return r ? I(n, !0, "low").spell : n;
			if (r) return n;
			var o = I(n, !1, "low");
			return -1 !== o.spell.indexOf("ü") && (o.spell = o.spell.replace("ü", "v")), r ? n : o
				.spell + o.tone
		}
		var I = function(n, e, r) {
			void 0 === e && (e = !1), void 0 === r && (r = "low"), -1 !== n.indexOf("v") && (n =
				n.replace("v", "ü"));
			var o, t, a = n[n.length - 1],
				u = -1,
				l = !1;
			parseInt(a).toString() === a ? (n = n.substr(0, n.length - 1), u = (t = i(n)).index,
				o = parseInt(a), l = !0, e && (n = _(n, u - 1, o))) : (u = (t = i(n)).index,
				o = t.tone, e || 0 === o || (n = t.spell));
		...
		function M(n, e, r, o, a) {
			if (void 0 === a && (a = !1), "object" != typeof r)
				if (o instanceof Array) o.forEach((function(o) {
					M(n, e, r, o, !0)
				}));
				else {
					var i = I(o),
					...
					if ((e = e).length >= 1) {
						for (var l = 0; l < e.length; l++) {
							var s = e[l];
							if (s.spell === i.spell && s.tone === i.tone) return
						}
						a || (a = !0)
					}
					var f = "" + r + (i.tone + (a ? 5 : 0));
					if (n[i.spell] = u ? u + f : i.index + ":" + f, 1 === e.length) {
						var c = e[0];
				...
				for (var p in r) M(n, e[p], p, r[p])
		}

		function D(n, e) {
			var r = x(n, [e, y.tone, y.poly]);
			return r === e ? [] : (-1 !== r.indexOf("|") ? r.substring(1, r.length - 1).split("|") :
				[r]).map((function(n) {
				return I(n)
			}))
		}
		...
		function U(n) {
			...
			return a.simple || a.trad || (a.simple = a.trad = !0), a.simple && (o += B(n, t
				.stroke)), a.trad && J.dict.getTradCount && (o += B(n, J.dict.getTradCount())), J
				.has(e, H.array) ? o.split("") : o
		}
		...
		function X(n, e) {
			if (void 0 === e && (e = !1), !e) return n.charCodeAt(0);
			var r = function(n) {
		...
		function K(n) {
			Y = n,
				function(n) {
					L = n, "aoeiuvn".split("").forEach((function(n) {
						for (var e = n.charCodeAt(0), r = 1; r <= 4; r++) F.push(e +
							.1 * r)
					}))
				}(n)
		}
		...
		function en(n, e) {
			var r = ["low"];
			if (e && r.push("tone"), Y.isCnChar(n)) return Y.spell.apply(Y, Z([n], r));
			try {
		...
		function rn(n, e, r) {
			if (void 0 === r && (r = !1), !(n = en(n, r))) return Q;
			if (!(e = en(e, r))) return V;
		...
		function on(n, e) {
			return "string" == typeof n && (n = Y.stroke(n)), "string" == typeof e && (e = Y.stroke(
				e)), n > e ? Q : n < e ? V : nn
		}
		var tn = function(n) {
				var e = function() {
				...
				return e.__default = !0, e
			},
			an = [];

		function un(n) {
			return -1 === an.indexOf(n) && (an.push(n), !0)
		}
		var ln = "";
		var sn = "object" == typeof wx && "object" == typeof __wxConfig ? "miniapp" : "object" ==
			typeof window ? "web" : "node",
			fn = function() {
				return (fn = Object.assign || function(n) {
					for (var e, r = 1, o = arguments.length; r < o; r++)
						for (var t in e = arguments[r]) Object.prototype.hasOwnProperty
							.call(e, t) && (n[t] = e[t]);
					return n
		...
		var dn, gn, vn, yn, mn, xn = fn(fn({
			...
			use: function() {
				for (var n = [], e = 0; e < arguments.length; e++) n[e] = arguments[
					e];
				var r = m();
				n.forEach((function(n) {
					...
					if (e) {
						if (un(e)) {
							var a = r;
							t && (a.type[e] = t), n.getCnChar =
								function() {
									return r
								}, n.installed = !0, a[e] = n, o && o(r)
						}
					} else l("plugin name is required", n)
				}))
			},
			_: {
				arg: y,
				...
				checkTrad: function(n, e) {
					if (-1 === e.indexOf("trad") || -1 === g.plugins.indexOf(
						"trad")) return n;
					var r = !1;
					return n instanceof Array && (r = !0, n = n.join("")), n = g
						.convert.tradToSimple(n), r ? n.split("") : n
				},
				...
				pickRandomChar: function(n, e) {
					return void 0 === e && (e = 1), n ? f(n.split(""), e).join("") :
						""
				}
			},
			type: {
			...
			isPolyWord: function(n) {
				return "" !== n && (n.length > 1 && (n = n[0]), !!h(n) && -1 !== t
					.info.polyWord.indexOf(n))
			},
			shapeSpell: P,
			hasTone: function(n) {
			...
			spellToWord: function() {
				...
				if ("string" != typeof r) throw new Error("spellToWord: 输入必须是字符串");
				...
				for (var s = "", f = t.spell[i.spell].substr(2), c = 0; c < f
					.length; c += 2) {
					var p = f[c],
						h = parseInt(f[c + 1]),
						d = h > 4;
					d && (h -= 5), -1 !== s.indexOf(p) || !l.alltone && h !== i
						.tone || l.poly && !d || (s += p)
				}
				if (l.trad && o.convert) {
					var g = "";
			...
			setResourceBase: function(n) {
				var e = this;
				ln = n, this.plugins.forEach((function(n) {
					var r, o = e[n];
					o && (null === (r = o._refreshResource) ||
						void 0 === r || r.call(o, e))
				}))
			}
		}, (dn = tn("draw"), gn = tn("idiom"), vn = tn("radical"), yn = tn("xhy"),
			"object" == typeof window && (window.CncharIdiom = gn, window.CncharDraw =
				dn, window.CncharRadical = vn, window.CncharXHY = yn), {
				idiom: gn,
				draw: dn,
				setOrder: tn("order"),
		...
		String.prototype.spell = function() {
			...
			}, g = xn, o = (mn = xn)._, i.tones = o.tones.split(""), i.initials = t.info.initial, mn
			.spellInfo = i, mn.type.spellToWord = a,
			function(n) {
				n.strokeToWord = U, n.type.strokeToWord = H, J = n._
